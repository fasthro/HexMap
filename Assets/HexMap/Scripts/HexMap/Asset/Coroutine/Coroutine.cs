...
namespace HexMap.Runtime
{
    ...
    public class Coroutine
    {
        ...
        /// <returns></returns>
        public static Coroutine Allocate(IEnumerator routine, bool autoStart = true, Action<bool> completeCallback = null)
        {
            return (new Coroutine()).Initialize(routine, autoStart, completeCallback);
        }
        ...
        private Coroutine Initialize(IEnumerator routine, bool autoStart, Action<bool> completeCallback = null)
        {
            _routine = routine;
        ...
        IEnumerator CallWrapper()
        {
            ...
            _completeCallback?.Invoke(stopped);
        }
    }
}