...
namespace AmplifyShaderEditor
{
	...
	public class AmplifyShaderEditorWindow : SearchableEditorWindow, ISerializationCallbackReceiver
	{
		...
		void OnRightMouseUp()
		{
			//Resetting the hot control FinishCallback variable so it can be used again on right mouse drag detection ( if we did not do this then m_lastHotControl could be left with a a value of 0 and wouldn't be able to be correctly used on rthe drag ) 
			m_lastHotControl = -1;
